...
namespace KutuphaneSistemi
{
    ...
    class Program
    {
        ...
        {
            new Kitap { Ad = "1984", Yazar = "George Orwell", YayınYılı = 1949, StokAdedi = 5 },
            new Kitap { Ad = "Suç ve ceza", Yazar = "fyodor dostoyevski", YayınYılı = 1866, StokAdedi = 10 },
            new Kitap { Ad = "Simyacı", Yazar = "Paulo Coelho", YayınYılı = 1988, StokAdedi = 7 }
        };
        ...
        static List<KiralamaBilgisi> kiralamaBilgileri = new List<KiralamaBilgisi>
        {
            new KiralamaBilgisi
            {
                KullaniciAdi = "Görkem Ali Karabulut",
                KitapAdi = "1984",
                KiralamaSuresi = 7,
                IadeTarihi = DateTime.Now.AddDays(3) // 3 gün içinde iade edilmesi gerekiyor
            },
            new KiralamaBilgisi
            {
                KullaniciAdi = "Jale Firuze Sinanoğulları", //isim uydurması zormuş :3
                KitapAdi = "Suç ve ceza",
                KiralamaSuresi = 10,
                IadeTarihi = DateTime.Now.AddDays(5) // 5 gün içinde iadeetmesi gerekiyor
            }
        };
        ...
        static void Main(string[] args)
        {
            while (true)
            {
                ...
                switch (secim)
                {
                    ...
                    case "0": return;
                    default: Console.WriteLine("Geçersiz seçim, tekrar deneyin :3"); break;
                }
            }
        }
        ...
        static void KitapKirala()
        {
            ...
            if (butce < ucret)
            {
                Console.WriteLine("Bütçe yetmiyor."); //TT
                Console.ReadLine();
                return;
            }
